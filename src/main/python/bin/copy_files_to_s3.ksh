...
LOGFILE="/home/gaoyinghan1997/projectsocial/PrescriberAnalytics/src/main/python/logs/${JOBNAME}_${date}.log"
...
LOCAL_OUTPUT_PATH="/home/gaoyinghan1997/projectsocial/PrescriberAnalytics/src/main/python/output"
...
do
  aws s3 --profile myprofile cp ${file} "s3://prescripipeline/dimension_city/$bucket_subdir_name/"
  echo "City File $file is pushed to S3."
done

for file in ${LOCAL_FACT_DIR}/*.*
do
  aws s3 --profile myprofile cp ${file} "s3://prescripipeline/presc/$bucket_subdir_name/"
